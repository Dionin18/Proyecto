...
<body>
    ...
    <div class="container">
        <div class="mt-4 p-5 bg-secondary text-white rounded">
            <h1>Perfil</h1>
            <p>Este es su perfil de usuario</p>
        </div>
    </div>
    <!--CIERRE TITULAR-->
    ...
    <div class="container" style="text-align:center;">
        <div class="card" style="width: 18rem;">
            <img src="<?php echo $aux[6]; ?>" class="card-img-top" alt="fotoPerfil" style="height: 18rem;">
                <div class="card-body">
                    <p class="card-text">
                        <b>Nombre: </b><?php echo "$aux[0] $aux[1]"?><br>
                        <b>Rut: </b><?php echo $aux[2];?><br>
                        <b>Teléfono: </b><?php echo $aux[3];?><br>
                        <b>Correo: </b><?php echo $aux[4];?><br>
                    </p>
                </div>
        </div>
    </div>

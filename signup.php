    ...
    <div class="container">
        <div class="row">
            ...
            <form action="procesarSignup.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" placeholder="12.345.678-9" pattern="[0-9.-]{11}" name="rut" id="rut" class="form-control" required>

                <br>

                <label for="telefono" class="form-label">Telefono (+56):</label>
                <input type="tel" placeholder="999999999" pattern="[0-9]{9}" name="telefono" id="telefono" class="form-control" required>
                ...
                <input type="submit" value="Crear Cuenta" class="btn btn-outline-primary btn-lg">
            </form>
            </div>
        </div>
    </div>

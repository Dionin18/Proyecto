        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar-brand" href="login.php">Ejercicios</a>
                    </li>
                </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default" style="background-color: #cfcfcf; border-radius:15px;">
            ...
            while($col = $resultado->fetch_array()) {
                echo '<div class="row">';
                    echo '<div class="col-md-12" style="border-radius:15px;">';
                        echo '<div class="panel panel-default" style="background-color: #cfcfcf; border-radius:15px;">';
